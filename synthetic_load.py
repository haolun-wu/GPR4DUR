...
item_clusters = np.load(
    '/home/haolun/projects/def-cpsmcgil/haolun/GPR4DUR/synthetic_data/synthetic_data_interest-power1.0_item-power1.0_alpha0.8_gamma0.1/item_clusters.npy')
items = np.load(
    '/home/haolun/projects/def-cpsmcgil/haolun/GPR4DUR/synthetic_data/synthetic_data_interest-power1.0_item-power1.0_alpha0.8_gamma0.1/items.npy')
user_interests = np.load(
    '/home/haolun/projects/def-cpsmcgil/haolun/GPR4DUR/synthetic_data/synthetic_data_interest-power1.0_item-power1.0_alpha0.8_gamma0.1/user_interests.npy')
...
user_item_sequences = np.load(
    '/home/haolun/projects/def-cpsmcgil/haolun/GPR4DUR/synthetic_data/synthetic_data_interest-power1.0_item-power1.0_alpha0.8_gamma0.1/user_item_sequences.npy')
...
if __name__ == '__main__':
    ...
    print("user_item_sequences:", user_item_sequences)